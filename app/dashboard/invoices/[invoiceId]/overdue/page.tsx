...
import { OverdueInvoiceAction } from "@/app/actions";
...
export default async function OverdueInvoice({ params }: { params: Params }) {
        ...
        <div className="flex flex-1 items-center justify-center">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Are you sure you want to mark this invoice as Overdue?</CardDescription>
                </CardHeader>
                <CardContent>
                    <Image 
                        src={PaidGif}
