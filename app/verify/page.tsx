    ...
    <div className='min-h-screen w-full flex items-center justify-center'>
        ...
        <Card className='w-[380] px-5'>
            <CardHeader className='text-center'>
                ...
                <CardTitle className='text-2xl font-bold'>Please check your email</CardTitle>
                <CardDescription>We have sent an email verification link to your email address.</CardDescription>
            </CardHeader>
